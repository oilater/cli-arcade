...
import type { BombClientMessage, BombServerMessage } from "../server/protocol.ts"
...
export function useBombServer(address: string, playerName: string): BombServerConnection {
